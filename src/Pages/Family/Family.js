            ...
            <div className='happiness-container'>
                <div className='happiness-left-img happiness-img'>
                    <div className='ballonImag'>
                        <img className='gsapHappinessSmokeMachine' src='https://gea-eid-p2.stocker.team/static/media/GiftContainer.021292d382905b880cbb.png' alt='' />
                    </div>
                    <div className='smokeImage'>
                        <img className='gsapHappinessSmoke' src='https://gea-eid-p2.stocker.team/static/media/GiftTop.89e441526fae2b99eccb.png' alt='hpysmoke' />
                    </div>
                </div>
                ...
                <div className='happiness-right-img happiness-img' >
                    <div className='shineImage'>
                        <div className='gsapHapinessShine'>
                            <img className='img-fit' src='https://gea-eid-p2.stocker.team/static/media/W_01.042cbd1772af70a99957.png'/>
                        </div>
                    </div>
